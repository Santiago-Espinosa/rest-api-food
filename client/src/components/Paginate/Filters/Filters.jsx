  ...
  tickCheckbox(e) {
    if (e.target.checked) {
      ...
      this.setState((state) => {
        return {
          ...state,
          markedDiets: state.markedDiets.filter(
      ...
      <div className={style.side}>
        ...
        <div className={style.orderConteiner}>
          <button
            ...
            onClick={(e) => this.tickOrder(e, "string", true, "name")}
          >
            A - Z
          </button>
          ...
          <button
            ...
            onClick={(e) => this.tickOrder(e, "string", false, "name")}
          >
            Z - A
          </button>
        </div>
        ...
        <div className={style.orderConteiner}>
          <button
            ...
            onClick={(e) => this.tickOrder(e, "number", true, "healthScore")}
          >
            Lower
          </button>
          ...
          <button
            ...
            onClick={(e) => this.tickOrder(e, "number", false, "healthScore")}
          >
            Higher
          </button>
        </div>
        ...
        <button className={style.resetButton} onClick={this.reset}>
          Reset
        </button>
      </div>
    );
